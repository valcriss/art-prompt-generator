...
export const guidedVocabulary = {
  subjectType: [
    { value: 'person', labels: { en: 'Person', fr: 'Personne' }, group: 'core' },
    { value: 'group of people', labels: { en: 'Group of people', fr: 'Groupe de personnes' }, group: 'core' },
    { value: 'couple', labels: { en: 'Couple', fr: 'Couple' }, group: 'core' },
    { value: 'family', labels: { en: 'Family', fr: 'Famille' }, group: 'core' },
    { value: 'friends', labels: { en: 'Friends', fr: 'Amis' }, group: 'core' },
    { value: 'crowd', labels: { en: 'Crowd', fr: 'Foule' }, group: 'core' },
    { value: 'street scene', labels: { en: 'Street scene', fr: 'Scene de rue' }, group: 'core' },
    { value: 'daily life moment', labels: { en: 'Daily life moment', fr: 'Moment de vie quotidienne' }, group: 'core' },
    { value: 'human interaction', labels: { en: 'Human interaction', fr: 'Interaction humaine' }, group: 'core' },
    { value: 'candid moment', labels: { en: 'Candid moment', fr: 'Moment pris sur le vif' }, group: 'core' },
    { value: 'documentary scene', labels: { en: 'Documentary scene', fr: 'Scene documentaire' }, group: 'narrative' },
    { value: 'editorial lifestyle scene', labels: { en: 'Editorial lifestyle scene', fr: 'Scene lifestyle editoriale' }, group: 'core' },
    { value: 'fashion editorial scene', labels: { en: 'Fashion editorial scene', fr: 'Scene editoriale de mode' }, group: 'core' },
    { value: 'travel moment', labels: { en: 'Travel moment', fr: 'Moment de voyage' }, group: 'narrative' },
    { value: 'ceremony scene', labels: { en: 'Ceremony scene', fr: 'Scene de ceremonie' }, group: 'narrative' },
    { value: 'workspace scene', labels: { en: 'Workspace scene', fr: 'Scene d espace de travail' }, group: 'core' },
    { value: 'interior living scene', labels: { en: 'Interior living scene', fr: 'Scene de vie en interieur' }, group: 'core' },
    { value: 'outdoor lifestyle scene', labels: { en: 'Outdoor lifestyle scene', fr: 'Scene lifestyle en exterieur' }, group: 'core' },
    { value: 'environmental portrait', labels: { en: 'Environmental portrait', fr: 'Portrait en situation' }, group: 'narrative' },
    { value: 'full-body character study', labels: { en: 'Full-body character study', fr: 'Etude de personnage en pied' }, group: 'narrative' },
    { value: 'subject in context', labels: { en: 'Subject in context', fr: 'Sujet dans son contexte' }, group: 'core' },
    { value: 'people in motion', labels: { en: 'People in motion', fr: 'Personnes en mouvement' }, group: 'cinematic' },
    { value: 'quiet observational scene', labels: { en: 'Quiet observational scene', fr: 'Scene d observation calme' }, group: 'atmospheric' },
    { value: 'public space moment', labels: { en: 'Public space moment', fr: 'Moment en espace public' }, group: 'core' },
    { value: 'ritual scene', labels: { en: 'Ritual scene', fr: 'Scene rituelle' }, group: 'narrative' },
    { value: 'performance scene', labels: { en: 'Performance scene', fr: 'Scene de performance' }, group: 'cinematic' },
